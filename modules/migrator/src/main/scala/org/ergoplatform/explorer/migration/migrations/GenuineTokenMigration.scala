...
/** TODO:
  *   new PR to add/remove token from genuine token list
  *   via csv list: tokens are then added / removed from file
  *   and when PR is merged migrationBatch is run via CI updating the
  *   genuine token list // do the same for blocked token list
  *   eip/0021/genuine.csv && eip/0021/blocked.csv
  */
