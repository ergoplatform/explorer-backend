...
import org.ergoplatform.explorer.{Address, BoxId, HexString, Id, LiftConnectionIO, TokenId, TxId}
...
object OutputRepo {
  ...
  final private class Live[D[_]: LiftConnectionIO](implicit lh: LogHandler)
    ...
    def sumOfAllMainUnspentByErgoTree(ergoTree: HexString, maxHeight: Int): D[Long] =
      QS.sumOfAllMainUnspentByErgoTree(ergoTree, maxHeight).unique.liftConnIO
