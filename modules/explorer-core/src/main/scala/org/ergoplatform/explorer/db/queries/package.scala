...
package object queries {
  ...
  def innerJoinAllOfRegisters(as: String, tableAlias: String, props: NonEmptyList[(RegisterId, String)]): String =
    s"""
       |inner join (
  ...
  def innerJoinAllOfAssets(as: String, tableAlias: String, props: NonEmptyList[TokenId]): String =
    s"""
       |inner join (
